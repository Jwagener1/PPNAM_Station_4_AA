package com.ppnam.station4aa.ui.session
...
import com.ppnam.station4aa.navigation.NavRoutes

/**
 * Sends the operator back to Login whenever the session disappears. Ported from Station 2 AA's
 * SessionWatcher — see `com.ppnam.station4aa.data.mqtt.MqttTopics`' class doc. Adapted to take

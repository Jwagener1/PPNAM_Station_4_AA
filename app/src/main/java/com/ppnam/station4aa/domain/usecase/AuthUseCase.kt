package com.ppnam.station4aa.domain.usecase

import com.ppnam.station4aa.data.auth.ScramExchange
import com.ppnam.station4aa.data.mqtt.EmptyPayload
import com.ppnam.station4aa.data.mqtt.MqttOutcome
import com.ppnam.station4aa.data.mqtt.MqttRequestChannel
import com.ppnam.station4aa.data.mqtt.describe
import com.ppnam.station4aa.data.mqtt.dto.BadgeLoginPayload
import com.ppnam.station4aa.data.mqtt.dto.OperatorContextResponse
import com.ppnam.station4aa.data.mqtt.dto.ScramPurpose
...
import com.ppnam.station4aa.domain.model.SessionState
import java.time.Instant

/** Ported from Station 2 AA's LoginMethod/AuthUseCase — see
 * `com.ppnam.station4aa.data.mqtt.MqttTopics`' class doc. */

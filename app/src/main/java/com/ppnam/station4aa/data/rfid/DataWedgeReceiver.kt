package com.ppnam.station4aa.data.rfid
 ...
 * `com.ppnam.station4aa.ACTION_SCAN` specifically — that's a provisioning step, not code.
 */
class DataWedgeReceiver(
    ...
    companion object {
        ...
        const val ACTION_SCAN = "com.ppnam.station4aa.ACTION_SCAN"
